...
public class VideoItemListFragment extends ListFragment {
    ...
    private class SearchRunnable implements Runnable {
        ...
        boolean bUploaderVideos = false;
        private final int requestId;
        public SearchRunnable(SearchEngine engine, String query, int page, boolean bUploaderVideos, int requestId) {
            this.engine = engine;
            this.query = query;
            this.page = page;
            this.bUploaderVideos = bUploaderVideos;
            this.requestId = requestId;
        }
        void terminate() {
            runs = false;
        ...
        public void run() {
            ...
            try {
                ...
                result = SearchResult
                        .getSearchResult(engine, query, page, bUploaderVideos, searchLanguage, new Downloader());
    ...
    public void search(String query, boolean bUploaderVideos) {
        mode = SEARCH_MODE;
        this.query = query;
        //COMP 530
        //to diferenciate between channel videos and searched query videos
        this.bUploaderVideos = bUploaderVideos;
        this.lastPage = 1;
    ...
    private void startSearch(String query, int page) {
        ...
        terminateThreads();
        //COMP 530
        //query = "https://www.youtube.com/channel/UCP3Dp2rGnmtrWjAro-FsxvA/videos";
        searchRunnable = new SearchRunnable(streamingService.getSearchEngineInstance(new Downloader()),
                                            query, page, bUploaderVideos, currentRequestId);
